...
- **Always document non-obvious logic changes with comments** — Add comments only when the WHY is non-obvious: hidden constraints, subtle invariants, workarounds for specific bugs, or behavior that would surprise a reader.
